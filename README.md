...
Networking note (sprint): sprint speed is evaluated inside CharacterMovement prediction (saved-move flags) to prevent client sprint jitter/corrections. To validate:

- Use PIE with 2+ players
- Enable corrections display: `p.NetShowCorrections 1`
- Add artificial lag: `NetEmulation.PktLag 150`
- Toggle sprint while moving and confirm corrections are reduced
